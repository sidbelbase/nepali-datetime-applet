...
nep_years_and_days = [[2000, 30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31],
...
# ? Makes sure both the dates are on the same day
...
# ? checks if the given year is leap i.e 366 days
...
# ? Checks if the given date is in range and converts the english date into nepali
...
# ? It checks if the given date lies in the range between 1944 to 2033
